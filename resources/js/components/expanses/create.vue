                    ...
                    <div class="card">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div class="card-title mb-0">
                                <h4 class="mb-0">Add New Expanses</h4>
                            </div>
                            ...
                            <div class="card  ">
                                <div class="card-body">
                                    <div id="calendar1" class="calendar-s">
                                        ...
                                        <form @submit.prevent="ExpansesInsert" enctype="multipart/form-data">
...
export default {
    ...
    methods:{
        ExpansesInsert(){
            ...
            axios.post('/api/expanses/',this.form)
            .then(()=>{
                Toast.fire({
                    icon: 'success',
                    title: 'expanses added successfully'
                })
